...
This project is based on the WS4000+ project by Matt Walsh, which you can find [here](https://github.com/netbymatt/ws4kp). My version has diverged somewhat, with some simplification. That project will probably be kept more up to date than this one.
