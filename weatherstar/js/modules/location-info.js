...
class LocationInfo extends WeatherDisplay {
  ...
  async getData(weatherParameters, refresh) {
    ...
    this.elem.querySelector(".station-id").textContent =
      this.weatherParameters.stationId;
    this.elem.querySelector(".radar-id").textContent =
      this.weatherParameters.radarId;
    this.elem.querySelector(".zone-id").textContent =
      this.weatherParameters.zoneId;
    this.elem.querySelector(".weather-office").textContent =
      this.weatherParameters.weatherOffice;
    this.elem.querySelector(".time-zone").textContent =
