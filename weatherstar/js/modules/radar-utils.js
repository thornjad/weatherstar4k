...
const removeDopplerRadarImageNoise = RadarContext => {
  ...
  for (let i = 0; i < RadarImageData.data.length; i += 4) {
    ...
    if (
      ...
      B = 19;
      A = 255;
    } else if ((R === 214 && G === 0 && B === 0) || (R === 255 && G === 0 && B === 0)) {
      // Red
      R = 171;
      G = 14;
      B = 14;
      A = 255;
    } else if ((R === 192 && G === 0 && B === 0) || (R === 255 && G === 0 && B === 255)) {
      // Brown
      R = 115;
      G = 31;
      B = 4;
...
export { getXYFromLatitudeLongitudeDoppler, getXYFromLatitudeLongitudeMap, removeDopplerRadarImageNoise };
